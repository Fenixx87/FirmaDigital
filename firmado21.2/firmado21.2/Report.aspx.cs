...
namespace firmado21._2
{
    public partial class Reporte : System.Web.UI.Page
    {
        ...
        protected void btnLlenar_Click(object sender, EventArgs e)
        {
            ...
            XtraReport2 Page = new XtraReport2();
            ...
            //alias del certificado (nombre del firmante)
            ...
            //creacion de la imagen para la firma
            // Create a QR code.
            ...
            string ruta = savePath + "reporte-nofirma.pdf";
            ...
            string FinalPath = savePath + "reporte-firmado.pdf";
